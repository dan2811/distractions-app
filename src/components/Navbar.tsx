  ...
  return (
    <PaperProvider>
      <View style={styles.container}>
        <TouchableOpacity
          onPress={() =>
            handleNavigation(setActiveScreen, navigation, activeScreen, 'Home')
          }
          style={styles.center}>
          <Icon
            name="home"
        ...
        <TouchableOpacity
          onPress={() =>
            handleNavigation(setActiveScreen, navigation, activeScreen, 'Event')
          }
          style={styles.center}>
          <Icon
            name="event"
        ...
        <TouchableOpacity
          ...
          />
          <Badge visible={true} size={21} style={{position: 'absolute'}}>
            10
          </Badge>
          <Text
            style={
